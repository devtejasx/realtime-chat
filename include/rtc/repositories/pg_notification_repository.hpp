...
public:
    ...
    [[nodiscard]] models::Notification create(std::int64_t user_id, models::NotificationType type,
                                              const nlohmann::json& payload) override;
    [[nodiscard]] std::vector<models::Notification> list_for_user(
        std::int64_t user_id, const dto::Pagination& page, bool unread_only) override;
