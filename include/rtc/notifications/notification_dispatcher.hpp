...
class INotificationDispatcher {
  public:
    ...
    virtual void new_message(std::int64_t sender_id,
                             std::int64_t conversation_id,
                             std::int64_t message_id,
                             const std::vector<std::int64_t>& recipient_ids) noexcept = 0;

    virtual void added_to_group(std::int64_t conversation_id,
                                std::int64_t added_user_id,
                                std::int64_t actor_id) noexcept = 0;

    virtual void removed_from_group(std::int64_t conversation_id,
                                    std::int64_t removed_user_id,
                                    std::int64_t actor_id) noexcept = 0;

    virtual void reaction_added(std::int64_t message_author_id,
                                std::int64_t message_id,
                                std::int64_t reactor_id,
                                std::string_view emoji) noexcept = 0;
...
class NullNotificationDispatcher final : public INotificationDispatcher {
  public:
    ...
    void reaction_added(std::int64_t,
                        std::int64_t,
                        std::int64_t,
