...
public:
    ...
    void new_message(std::int64_t sender_id, std::int64_t conversation_id,
                     std::int64_t message_id,
                     const std::vector<std::int64_t>& recipient_ids) noexcept override;
    void added_to_group(std::int64_t conversation_id, std::int64_t added_user_id,
                        std::int64_t actor_id) noexcept override;
    void removed_from_group(std::int64_t conversation_id, std::int64_t removed_user_id,
                            std::int64_t actor_id) noexcept override;
    void reaction_added(std::int64_t message_author_id, std::int64_t message_id,
                        std::int64_t reactor_id, std::string_view emoji) noexcept override;
