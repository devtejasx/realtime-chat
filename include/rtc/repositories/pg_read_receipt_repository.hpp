...
public:
    ...
    [[nodiscard]] models::ReadReceipt upsert_state(std::int64_t message_id, std::int64_t user_id,
                                                   models::ReceiptState state) override;
    void mark_conversation_read(std::int64_t conversation_id, std::int64_t user_id,
