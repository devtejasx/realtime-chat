...
// migration 0011.
class PgUserAdminRepository final : public database::BaseRepository,
                                   public IUserAdminRepository {
public:
    ...
    void set_banned(std::int64_t user_id, bool banned, std::optional<std::string> reason,
